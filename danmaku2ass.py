...
def main():
    ...
    parser.add_argument('-s', '--size', metavar=_('WIDTHxHEIGHT'), default='1960x1080', type=str, help=_('Stage size in pixels [default: %s]') % _('1960x1080'))
    ...
    parser.add_argument('-fs', '--fontsize', metavar=_('SIZE'), help=(_('Default font size [default: %s]') % 35), type=float, default=35.0)
    parser.add_argument('-a', '--alpha', metavar=_('ALPHA'), help=_('Text opacity'), type=float, default=1.0)
    parser.add_argument('-dm', '--duration-marquee', metavar=_('SECONDS'), help=_('Duration of scrolling comment display [default: %s]') % 10, type=float, default=10.0)
    parser.add_argument('-ds', '--duration-still', metavar=_('SECONDS'), help=_('Duration of still comment display [default: %s]') % 10, type=float, default=10.0)
    ...
    parser.add_argument('-p', '--protect', metavar=_('HEIGHT'), help=_('Reserve blank on the bottom of the stage [default: %s]') % 100, type=int, default=100)
